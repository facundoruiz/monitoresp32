...
class ConectorWIFI:
    def __init__(self, ap_ssid='WifiConector', ap_password='wificonector', debug=False):
         # Add verification for WLAN module
    ...
    def monitor_connections(self):
        ...
        while True:
            try:
                ...
                if time() - self.last_display_update >= 2:
                ...
                if self.web_server_active:
                    try:
                        self.server_socket.settimeout(0.1)  # Reducimos el timeout
                ...
                # Solo mostrar errores que no sean timeouts
    ...
    def setup_web_server(self):
        ...
        try:
            ...
            # Configurar timeout más corto para el socket
            self.server_socket.settimeout(0.1)
            # Intentar hacer bind con reintento
            retry_count = 0
            while retry_count < 3:
                try:
